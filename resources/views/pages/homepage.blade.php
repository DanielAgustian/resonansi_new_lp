                                    ...
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <div>
                                            <a href="#"
                                                class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">Top
                                                Engagement</a>
                                            <div class="font-size-sm text-muted font-weight-bold mt-1">KT.com solution
                                                provider</div>
                                        </div>
                                    </div>
                                    <div
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">790
                                            </div>
                                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1">New
                                                Products</a>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pl-0">
                                                <a href="#"
                                                    ...
                                                    Clarcson</a>
                                                <span class="text-muted font-weight-bold text-muted d-block">C#, ASP.NET,
                                                    MS SQL</span>
                                            </td>
                                            <td>
                                                <span
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="flex-grow-1 pb-5">
                                ...
                                <!--begin::Desc-->
                                <p class="text-dark-50 font-weight-normal font-size-lg mt-6">Craft uses the latest and
                                    greatest frameworks
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="flex-grow-1 pb-5">
                                ...
                                <!--begin::Desc-->
                                <p class="text-dark-50 font-weight-normal font-size-lg mt-6">Easy to use, incredibly
                                    flexible and secure
