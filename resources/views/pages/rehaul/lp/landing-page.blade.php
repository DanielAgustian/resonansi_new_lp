            ...
            <div class="container clearfix">
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class="col-lg-9 col-md-11">
                        ...
                        <h2 class="text-center text-black">Software as Service</h2>
                        <div class="row align-items-center mt-5">
                            <div class="col-sm-6">
                                <img src="{{ asset('images/landing-service/landing-page-ill.png') }}" alt="Image 1"
                                    class="img-layanan">
                ...
                <div class="container">
                    <div class="row justify-content-between  mb-4 bottommargin" style="padding: 100px 0 160px;">
                        <div class="col-lg-5 col-md-6 offset-lg-1 pt-lg-0 pt-3">
                            ...
                            <h2 class="display-5  text-white">Berapa Harga Layanan <strong class="fw-bold">Landing
                                    Page Campaign</strong> Dari Resonansi?
