            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="row topmargin justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 mt-lg-0 mt-4">
                        ...
                        <h2 class="text-white fw-bold mb-3">Sudah promosi online di banyak platform tapi hasilnya belum
                            maksimal?
                        </h2>
                        <p class="text-white fw-normal mb-0">“Tenang! Landing Page Campaign dari Resonansi akan bantu kamu
                            membuat Landing Page yang menarik dan memberikan hasil yang maksimal untuk brand kamu. Mau tau
                            caranya? Yuk segera daftar dan konsultasikan permasalahanmu secara gratis!”
                        </p>
                        <div class="d-flex align-items-center justify-content-lg-start justify-content-center mt-5">
                            ...
                            <button class="btn btn-white btn-bigger btn-order"
                                data-type="paket-technology-conversion-opt">Order
                                Now!</button>
                        </div>
                    ...
                    <div class="col-lg-6  order-lg-2 order-1  flex-wrap justify-content-center">
                        <div class="swiper swiperBanner">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide d-flex flex-column h-100 justify-content-center">
                                    <img src="{{ asset('images/rehaul/website.png') }}" alt="" class="w-100 banner-img">
                                </div>
                    ...
                    <div class="col-lg-9 col-md-11">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="mb-2 text-center text-sm-start">Suatu metode untuk mendorong permintaan sebuah
                                    produk atau jasa, dan bagaimana permintaan produk atau jasa tersebut dapat terpenuhi
                                    serta menciptakan hubungan baik ke pelanggan dengan sarana media online.
                                </p>
                        ...
                        <div class="row align-items-center mt-4">
                            <div class="col-sm-6 mb-4 mb-sm-0 order-sm-1 order-2">
                                ...
                                <p class="mb-2 text-center text-sm-start">Merupakan suatu halaman website yang dibuat secara
                                    khusus untuk suatu program promosi atau marketing campaign dalam rangka meningkatkan
                                    penjualan produk atau jasa tertentu.
                                </p>
                        ...
                        <div class="row align-items-center mt-4">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="mb-2 text-center text-sm-start">Merupakan suatu teknik untuk mengoptimalkan sebuah
                                    website agar mendapat posisi teratas di mesin pencarian Google serta membantu
                                    meningkatkan konversi dan traffic website.
                                </p>
                ...
                <div class="container">
                    <div class="row justify-content-between  mb-4 bottommargin" style="padding: 100px 0 160px;">
                        <div class="col-lg-5 col-md-6 offset-lg-1 pt-lg-0 pt-3">
                            ...
                            <h2 class="display-5  text-white">Berapa Harga Layanan <strong class="fw-bold">Technology
                                    and Conversion Optimization</strong> Dari Resonansi?
                        ...
                        <div class="col-lg-12 center">
                            <div class="d-flex justify-content-center align-items-center">
                                <button class="button  button-primary fw-medium m-0 btn-order"
