            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="row topmargin justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 mt-lg-0 mt-4">
                        ...
                        <h2 class="text-white fw-bold mb-3">Ingin brand kamu semakin eksis di media sosial? <br>
                            Tapi masih bingung caranya?

                        </h2>
                        <p class="text-white fw-normal mb-0">“Kamu perlu menggunakan strategi yang tepat supaya brand kamu
                            dikenal banyak orang. Jadikan brand kamu eksis di social media dan buat orderan kamu semakin
                            meningkat bersama Resonansi dengan layanan Social Media Marketing.”
                        ...
                        <div class="d-flex align-items-center justify-content-lg-start justify-content-center mt-5">
                            ...
                            <button class="btn btn-white btn-bigger btn-order" data-type="social-media-marketing">Order
                                Now!</button>
                        </div>
        ...
        <div class="content-wrap pb-0">
                ...
                <div class="row justify-content-center mb-5">
                    <div class="col-lg-8 center">
                        <div class="heading-block">
                            <h3 class="nott mb-3 fw-semibold ls0">Layanan <span class="span-bl">Social Media
                                    Marketing</span> Yang Ditawarkan Oleh Resonansi</h3>
                    ...
                    <div class="col-lg-9 col-md-11">
                        <div class="row align-items-center">
                            <div class="col-sm-6 ">
                                <img src="{{ asset('images/rehaul/campaign.png') }}" alt="Image 1" class="img-layanan">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row align-items-center mt-5">
                            <div class="col-sm-6 mb-4 mb-sm-0 order-sm-1 order-2">
                                ...
                                <p class="mb-2 text-center text-sm-start">Strategi pengelolaan semua konten promosi yang
                                    akan diunggah ke social media, mulai dari jenis konten, materi konten, isi konten hingga
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-sm-6">
                                <h3 class="text-center text-sm-start">Content Management</h3>
                                <p class="mb-2 text-center text-sm-start">Merupakan teknik promosi untuk menciptakan dan
                                    mendistribusikan konten yang relevan dan berharga untuk menarik serta memperoleh target
                                    audience yang jelas.
                                </p>
                        ...
                        <div class="row align-items-center mt-5">
                            <div class="col-sm-6">
                                <h3 class="text-center text-sm-start">Digital Branding</h3>
                                <p class="mb-2 text-center text-sm-start">Merupakan suatu upaya untuk membangun merek dan
                                    image sebuah produk atau jasa di dunia digital dengan platform social media.
                                </p>

                            </div>
                            <div class="col-sm-6">
                                <img src="{{ asset('images/rehaul/branding.png') }}" alt="Image 1" class="img-layanan">
                            </div>
                        ...
                        <div class="row align-items-center mt-5">
                            ...
                            <div class="col-sm-6">
                                <h3 class="text-center text-sm-start">Brand Logo </h3>
                                <p class="mb-2 text-center text-sm-start">Merupakan suatu unsur yang sangat berpengaruh
                                    dalam sebuah produk atau jasa, berfungsi sebagai identitas yang mereprentasikan citra
                                    sebuah merek produk atau jasa di mata konsumen.
                                </p>
                ...
                <div class="container">
                    <div class="row justify-content-between  mb-4 bottommargin" style="padding: 100px 0 160px;">
                        <div class="col-lg-5 col-md-6 offset-lg-1 pt-lg-0 pt-3">
                            ...
                            <h2 class="display-5  text-white">Beberapa Fitur Layanan <strong class="fw-bold">Social
                                    Media Marketing</strong> Dari Resonansi?
                        ...
                        <div class="col-lg-5 col-md-6 mb-0 mb-md-5">
                            {{-- <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                ...
                                Accusantium!</p> --}}
                            <h3 class="mb-2 text-white">Beberapa Layanan Kami:</h3>
                            <div class="row">
                                <ul class="col-lg-8 col-md-10 col-12 iconlist">
                                    <li class="my-2"><i class="icon-line-circle-check fw-light"></i>
                                        <span class="ps-2 fw-bold">Social Media Marketing</span>
                        ...
                        <div class="col-lg-12 center">
                            <div class="d-flex justify-content-center align-items-center">
                                <button href="" class="button  button-primary fw-medium m-0 btn-order"
                                    data-type="social-media-marketing">Order Now</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section section-features section-klien bg-transparent mt-0 p-0 clearfix">
                <div class="container clearfix">
                    ...
                    <div class="row justify-content-center col-mb-50 col-mb-lg-80">
