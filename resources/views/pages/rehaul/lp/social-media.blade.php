                ...
                <div class="row topmargin justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 mt-lg-0 mt-4">
                        ...
                        <p class="text-white fw-normal mb-0">“Tenang bersama resonansi, kami akan terus tingkatkan
                            penjualan produk kamu dengan layanan marketplace optimization.”
                        </p>
                        <div class="d-flex align-items-center justify-content-lg-start justify-content-center mt-5">
                            ...
                            <button class="btn btn-white btn-bigger btn-order" data-type="paket-marketplace">Order Now!</button>
                        </div>
