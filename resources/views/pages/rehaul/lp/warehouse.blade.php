            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="row topmargin justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 mt-lg-0 mt-4">
                        ...
                        <h2 class="text-white fw-bold mb-3">Semakin kewalahan karena bisnis online kamu terus berkembang dan
                            banyak orderan?

                        </h2>
                        <p class="text-white fw-normal mb-0">“Tidak perlu khawatir karena Cloud Warehouse Software dari
                            Resonansi akan mempermudah flow transaksi kamu mulai dari mengatur stok barang, packing, hingga
                            orderan sampai ke pembeli.“
                        </p>
        ...
        <div class="content-wrap pb-0">
            ...
            <div class="section section-features section-klien bg-transparent mt-0 p-0 clearfix">
                <div class="container clearfix">
                    ...
                    <div class="row col-mb-50 col-mb-lg-80 justify-content-center">
