...
@section('css')
    ...
    <style>
        ...
        .banner-name {
            ...
            background: white;
            border-radius: 40px;
            border-left: 5px solid #0F66DD;
            border-bottom: 7px solid #0F66DD;
            margin-bottom: 5px;
            z-index: 99;
        }
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <div class="row topmargin justify-content-between align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 mt-lg-0 mt-4">
                        ...
                        <h2 class="text-white fw-bold mb-3 title-banner">Seperti sebuah garpu tala ketika bergetar, dapat
                            memberikan getaran yang sama kepada garpu tala yang memiliki frekuensi yang sama.
                        </h2>


                        </h2>
                        <p class="text-white fw-normal mb-0 title-detail">Resonansi ada untuk membantu sebuah brand agar
                            dapat satu
                        ...
                        <div class="d-flex align-items-center justify-content-lg-start justify-content-center mt-5">
                            <button class="btn btn-blue mr-4 me-4 btn-bigger btn-klien" style="min-width: 145px">Our
                                Client</button>
                            <a href="{{ route('pricingPageV2') }}" class="btn btn-white btn-bigger "
                                style="min-width: 145px">Pricing</a>
                        </div>
...
@section('content')
    <section id="content">
        ...
        <div class="content-wrap pb-0">
                ...
                <div class="row justify-content-center mb-5">
                    <div class="col-lg-8 center">
                        <div class="heading-block">
                            ...
                            <span class="text-black-80 mt-4">Membantu Bisnis Anda Untuk Menjadi <strong
                                    class="fw-bold">NOMOR 1 DI GOOGLE. MENINGKATKAN
                                    JUMLAH PENGUNJUNG</strong> Anda Secara Pasti. Meningkatkan <strong
                                    class=" fw-bold">EFISIENSI IKLAN</strong> Anda.</span>
                        </div>
                    </div>
            ...
            <div class="section section-klien p-0 dark mb-0"
                ...
                <div class="container">
                    ...
                    <div class="container  mb-4" style="padding: 0px 0 20px;">
                        ...
                        <div class="row justify-content-between  mb-4 " style="padding: 100px 0 160px;">
                            <div class="col-lg-5 col-md-6 offset-lg-1 pt-lg-0 pt-3">
                                ...
                                <h2 class="display-5  text-white">Siapa Saja Pengguna Jasa <strong
                                        class="fw-bold">Resonansi</strong>?

                                </h2>
                            </div>
                            <div class="col-lg-5 col-md-6 mb-0 mb-md-3">
                                ...
                                <div class="row justify-content-center ">
                                    ...
                                    <div class="col-lg-4 col-6  mb-3">
                                        <div class="feature-box media-box mb-2">
                                            ...
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Kopi Grontol</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/yutensil.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Yutensil</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/twg-2.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">TWG</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/warung_52.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Warung Makan 52</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/WGM.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Warisan Gajah Mada</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/WHW2_1.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Warisan Hayam Wuruk</h5>
                                    ...
                                    <div class="col-lg-4 col-6 mb-3">
                                        <div class="feature-box media-box mb-2">
                                            <img src="{{ asset('images/klien/logo-warisan.png') }}?v=1.0.0.1" alt=""
                                                class="w-100">
                                            <div class="fbox-content mt-1">
                                                <h5 class="nott fw-semibold text-center">Warisan.co.id</h5>
            ...
            <div class="" style="min-height: 100px">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <h2 class="text-center fw-semibold" style="margin-bottom: 20px">Masih Kurang Jelas, Hubungi<span
                            class="span-bl"> Tim Resonansi</span> !</h2>
            ...
            <div class="section section-gradient m-0">
                ...
                <div class="container">
                    <div class="mx-auto" style="max-width: 1200px; padding: 120px 0 50px;" data-aos="fade-up">
