                      ...
                      <div class="col-md-6 ">
                        <div class="d-flex justify-content-sm-start justify-content-center">
                          <div class="">
                            ...
                            <h3 class="h5 fw-bold mb-2 d-md-flex d-none"> Digital Strategy</h3>
                    ...
                    <div class="col-lg-12 ">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            ...
                            <div class="d-flex justify-content-center">
                              <h2 class="nott title-part-white text-center" style="font-size: 36px; max-width: 700px">Berapa Harga Untuk Jasa Layanan Social Media Marketing Di Resonansi? </h2>x
                            </div>

                        </div>
                        <div class="fw-normal lead text-center mb-5" style="color: rgb(221, 221, 221)">
                            Simak harga dan fitur dari layanan Social Media Marketing nya Resonansi!
                        </div>
