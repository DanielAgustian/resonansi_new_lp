                    ...
                    <div class="row align-items-center g-0">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div style="margin-right: 20px">
                                <h4 class="display-7 fw-bold text-white">Sudah pernah beriklan tetapi
                                      Hasilnya kurang memuaskan?
                                </h4>
                                <p class="lead mb-4 fw-normal">
                                  Tenang bersama Resonansi iklan kamu akan lebih
                                  optimal sehingga hasil penjualan semakin meningkat dan
                                  orderan semakin bertambah. Karena beriklan dengan
                                  Resonansi terbukti dapat membantu produkmu tampil
                                  lebih banyak di halaman calon pembeli dibandingkan
                                  produk lain yang tidak pernah di iklankan.
                                </p>
                                <div class="d-flex mt-7">
                                    <button class="btn btn-blue-bordered  btn-client bigger" style="margin-right: 15px">Our
                                        Client</button>

                                    <button class="btn btn-white-cus bigger btn-order"  data-type="conversion-optimization">Order Now</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-6 mt-md-0 mt-3">
                            <div class="slide-imgs">
                                ...
                                <img src="{{ asset('images/landing-service/conversion.png') }}" alt="Image" class="iphone-img">
                            </div>
        ...
        <div class="content-wrap pb-0">
            ...
            <div class="container">
                <div class="mx-auto center mt-0 bottommargin heading-block" style="max-width: 640px;">
                    <h5 class="text-uppercase ls1 text-muted mb-3" id="layanan-section">Layanan Conversion Optimization</h5>
                ...
                <div class="features-items mx-auto" style="max-width: 1000px;">
                    <div class="row align-items-center">
                      <div class="col-md-6">
                          <img src="{{asset('images/landing-service/conversion-ill.png')}}" alt="" class="img-landing-service">
                          <h2 class="h5 fw-bold mb-2 text-center mt-3">Conversion Optimization</h2>
                      </div>
                      <div class="col-md-6 ">
                        <div class="d-flex justify-content-sm-start justify-content-center">
                          <div class="">
                            <h2 class="h5 fw-bold mb-3 d-none">Conversion Optimization</h2>
                        ...
                        <div class="d-flex justify-content-sm-start justify-content-center mt-4">
                          <button class="btn text-white bg-color  btn-order rounded-3 p-3 fw-semibold text-uppercase"  data-type="conversion-optimization"> Order Now</button>
                    ...
                    <div class="col-lg-12 ">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            ...
                            <div class="d-flex justify-content-center">
                              <h2 class="nott title-part-white text-center" style="font-size: 36px; max-width: 700px">Berapa Harga Untuk Jasa Layanan Conversion Optimization Di Resonansi? </h2>x
                            </div>

                        </div>
                        <div class="fw-normal lead text-center mb-5" style="color: rgb(221, 221, 221)">
                            Simak harga dan fitur dari layanan Conversion Optimization nya Resonansi!
                        </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="row justify-content-around">
                          ...
                          @component('components.custom.layanan-card-single')
                              ...
                              <p class="list-data"><i class="fas fa-check-circle"></i>Google Ads
                              </p>


                              <p class="list-data"><i class="fas fa-check-circle"></i> Facebook Ads
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Instagram Ads
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Tiktok Ads
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Youtube Ads
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Email Marketing
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> SEO (Search Engine Optimization)
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Influencer & KOL Management
                              </p>
            ...
            <div class="row align-items-stretch align-content-stretch g-0 topmargin">
                ...
                <div class="col-md-12 col-12 bg-white dark order-md-1">
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <button class="btn btn-blue-bordered btn-order bigger" data-type="conversion-optimization">Order Now</button>
                    </div>
                    <div class="feature-pc"></div>
                </div>
