                    ...
                    <div class="row align-items-center g-0">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div style="margin-right: 20px">
                                <h4 class="display-7 fw-bold text-white">Punya Olshop atau bisnis online tapi
                                  sepi orderan?


                                </h4>
                                <p class="lead mb-4 fw-normal">“Tenang bersama resonansi, kami akan terus tingkatkan
                                  penjualan produk kamu dengan pelayanan maksimal
                                  namun budget yang minimal
                                  </p>
                                <div class="d-flex mt-7">
                                    <button class="btn btn-blue-bordered  btn-client bigger" style="margin-right: 15px">Our
                                        Client</button>

                                    <button class="btn btn-white-cus bigger btn-order" data-type="paket-marketplace">Order Now!</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-6 mt-md-0 mt-3">
                            <div class="slide-imgs">
                                ...
                                <img src="{{asset('images/landing-service/marketplace.png')}}?v=1.0" alt="Image" class="iphone-img">
                            </div>
        ...
        <div class="content-wrap pb-0">
            ...
            <div class="container">
                <div class="mx-auto center mt-0 bottommargin heading-block" style="max-width: 640px;">
                    <h5 class="text-uppercase ls1 text-muted mb-3" id="layanan-section">Layanan Marketplace</h5>
                ...
                <div class="features-items mx-auto" style="max-width: 1000px;">
                    <div class="row align-items-center">
                      <div class="col-md-6">
                          <img src="{{asset('images/landing-service/marketplace-opt-ill.png')}}" alt="" class="img-landing-service">
                          <h2 class="h5 fw-bold mb-2 text-center mt-3">MARKETPLACE OPTIMIZATION</h2>
                      </div>
                      <div class="col-md-6 ">
                        <div class="d-flex justify-content-sm-start justify-content-center">
                          <ul class="lead list-feature">
                            <li class="lead">Shops and Ads Optimization</li>
                            <li class="lead">Product Optimization</li>
                            <li class="lead">Marketplace Live Interaction</li>
                            <li class="lead">Marketplace Ads</li>
                          </ul>
                        </div>

                        <div class="d-flex justify-content-sm-start justify-content-center mt-4">
                          <button class="btn text-white bg-color  btn-order rounded-3 p-3 fw-semibold text-uppercase " data-type="paket-marketplace"> Order Now</button>
                    ...
                    <div class="col-lg-12 ">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            ...
                            <div class="d-flex justify-content-center">
                              <h2 class="nott title-part-white text-center" style="font-size: 36px; max-width: 700px">Berapa Harga Untuk Jasa Layanan Optimasi
                              Marketplace Di Resonansi? </h2>x
                            </div>

                        </div>
                        <div class="fw-normal lead text-center mb-5" style="color: rgb(221, 221, 221)">
                            Simak harga dan fitur dari layanan Optimasi Marketplace nya Resonansi!
                        </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="row justify-content-around">
                          ...
                          @component('components.custom.layanan-card-single')
                              ...
                              @endslot
                              @slot('title')
                                  Marketplace <br>(Online Sales Strategy)
                              @endslot
                              @slot('details')
            ...
            <div class="row align-items-stretch align-content-stretch g-0 topmargin">
                ...
                <div class="col-md-12 col-12 bg-white dark order-md-1">
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <button class="btn btn-blue-bordered btn-order bigger"  data-type="paket-marketplace">Order Now</button>
                    </div>
                    <div class="feature-pc"></div>
                </div>
