                    ...
                    <div class="row align-items-center g-0">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div style="margin-right: 20px">
                                <h4 class="display-7 fw-bold text-white">Sudah punya campaign tapi
                                  Hasilnya belum maksimal?
                                </h4>
                                <p class="lead mb-4 fw-normal">Mungkin masalahnya ada di Landing Page untuk
                                    audience bisa take action. Tenang bersama resonansi,
                                    kita akan buat Landing Page sebagus mungkin dengan
                                    pelayanan unggulan dari kami.
                                  </p>
                                <div class="d-flex mt-7">
                                    <button class="btn btn-blue-bordered  btn-client bigger" style="margin-right: 15px">Our
                                        Client</button>

                                    <button class="btn btn-white-cus bigger btn-order" data-type="paket-technology-conversion-opt">Order Now!</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-6 mt-md-0 mt-3">
                            <div class="slide-imgs">
                                ...
                                <img src="{{asset('images/landing-service/landing-page.png')}}?v=1.0" alt="Image" class="iphone-img">
                            </div>
        ...
        <div class="content-wrap pb-0">
            ...
            <div class="container">
                <div class="mx-auto center mt-0 bottommargin heading-block" style="max-width: 640px;">
                    <h5 class="text-uppercase ls1 text-muted mb-3" id="layanan-section">Layanan Landing Page</h5>
                ...
                <div class="features-items mx-auto" style="max-width: 1000px;">
                    <div class="row align-items-center">
                      <div class="col-md-6">
                          <img src="{{asset('images/landing-service/landing-page-ill.png')}}" alt="" class="img-landing-service">
                          <h2 class="h5 fw-bold mb-2 text-center mt-3">LANDING PAGE</h2>
                      </div>
                      <div class="col-md-6 ">
                        <div class="d-flex justify-content-sm-start justify-content-center">
                          <div class="">
                            <!-- <h2 class="h5 fw-bold mb-3">TECHNOLOGY</h2> -->
                            <h3 class="h6 fw-bold mb-2 d-md-block d-none">Technology</h3>
                            <ul class="lead list-feature mb-2">
                              <li class="lead">Company Profile Website</li>
                              <li class="lead">Landing Page Campaign</li>
                              <!-- <li class="lead">Marketplace Live Interaction</li> -->
                            </ul>
                            <h3 class="h6 fw-bold mb-2 ">Software as a Service</h3>
                            <ul class="lead list-feature mb-2">
                        ...
                        <div class="d-flex justify-content-sm-start justify-content-center mt-4">
                          <button class="btn text-white bg-color  btn-order rounded-3 p-3 fw-semibold text-uppercase " data-type="paket-technology-conversion-opt"> Order Now</button>
                    ...
                    <div class="col-lg-12 ">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            ...
                            <div class="d-flex justify-content-center">
                              <h2 class="nott title-part-white text-center" style="font-size: 36px; max-width: 700px">Berapa Harga Untuk Jasa Layanan Landing Page Di Resonansi? </h2>x
                            </div>

                        </div>
                        <div class="fw-normal lead text-center mb-5" style="color: rgb(221, 221, 221)">
                            Simak harga dan fitur dari layanan Landing Page nya Resonansi!
                        </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="row justify-content-around">
                          ...
                          @component('components.custom.layanan-card-single')
                              @slot('id')
                                  paket-technology-conversion-opt
                              @endslot
                              @slot('title')
                              ...
                              <p class="list-data"><i class="fas fa-check-circle"></i> Search Engine Optimization
                              </p>
                              <!-- <ul>
                                <li>AJAKIN (Referral Software Management System)</li>
                                <li>NGERTIYO  (Gamification Education Business)</li>
            ...
            <div class="row align-items-stretch align-content-stretch g-0 topmargin">
                ...
                <div class="col-md-12 col-12 bg-white dark order-md-1">
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <button class="btn btn-blue-bordered btn-order bigger" data-type="paket-technology-conversion-opt">Order Now</button>
                    </div>
                    <div class="feature-pc"></div>
                </div>
