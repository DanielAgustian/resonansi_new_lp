                    ...
                    <div class="row align-items-center g-0">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div style="margin-right: 20px">
                                <h4 class="display-7 fw-bold text-white">Brand kamu pengen eksis dan
                                penjualan meningkat drastis?


                                </h4>
                                <p class="lead mb-4 fw-normal">Tapi tidak paham strategi bermarketing di social media?
                              Tenang bersama resonansi, kita akan buat brand kamu
                              seEksis mungkin
                                  </p>
                                <div class="d-flex mt-7">
                                    ...
                                    <button class="btn btn-white-cus bigger btn-order" data-type="social-media-marketing">Order Now!</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-6 mt-md-0 mt-3">
                            <div class="slide-imgs">
                                ...
                                <img src="{{asset('images/landing-service/soc-med.png')}}?v=1.0" alt="Image" class="iphone-img">
                            </div>
        ...
        <div class="content-wrap pb-0">
            ...
            <div class="container">
                <div class="mx-auto center mt-0 bottommargin heading-block" style="max-width: 640px;">
                    <h5 class="text-uppercase ls1 text-muted mb-3" id="layanan-section">Layanan Social Media Marketing</h5>
                ...
                <div class="features-items mx-auto" style="max-width: 1000px;">
                    <div class="row align-items-center">
                      <div class="col-md-6">
                          <img src="{{asset('images/landing-service/socmed-ill.png')}}" alt="" class="img-landing-service">
                          <h2 class="h5 fw-bold mb-2 text-center mt-3">SOCIAL MEDIA MARKETING</h2>
                      </div>
                      <div class="col-md-6 ">
                        <div class="d-flex justify-content-sm-start justify-content-center">
                          <div class="">
                            <!-- <h2 class="h5 fw-bold mb-3">Digital Strategy</h2> -->
                            <h3 class="h6 fw-bold mb-2 ">Social Media Marketing</h3>
                            <ul class="lead list-feature">
                              <li class="lead">Campaign</li>
                              <li class="lead">Matrix Plan</li>
                              <li class="lead">Content Management</li>
                              <li class="lead">Digital Branding</li>
                              <li class="lead">Brand Logo</li>
                            </ul>
                          </div>
                        ...
                        <div class="d-flex justify-content-sm-start justify-content-center mt-4">
                          <button class="btn text-white bg-color  btn-order rounded-3 p-3 fw-semibold text-uppercase" data-type="social-media-marketing"> Order Now</button>
                    ...
                    <div class="col-lg-12 ">
                        <div class="heading-block border-bottom-0 bottommargin-sm">
                            ...
                            <div class="d-flex justify-content-center">
                              <h2 class="nott title-part-white text-center" style="font-size: 36px; max-width: 700px">Berapa Harga Untuk Jasa Layanan Social Media Di Resonansi? </h2>x
                            </div>

                        </div>
                        <div class="fw-normal lead text-center mb-5" style="color: rgb(221, 221, 221)">
                            Simak harga dan fitur dari layanan Marketing Sosial Media nya Resonansi!
                        </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="row justify-content-around">
                          ...
                          @component('components.custom.layanan-card-single')
                              ...
                              <p class="list-data"><i class="fas fa-check-circle"></i>Social Media Marketing
                              </p>
                              <ul>
                                <li>Campaign</li>
                                <li>Matrix Plan</li>
                              ...
                              <p class="list-data"><i class="fas fa-check-circle"></i>Conversion Optimization
                              </p>
                              <ul>
                                <li>Google Ads</li>
                                <li>Facebook Ads</li>
                              ...
                              <!-- <p class="list-data"><i class="fas fa-check-circle"></i> KPI: Total Viewer 20.000 - 40.000
                              </p>
                              <p class="list-data"><i class="fas fa-check-circle"></i> Exclude Giveaway</p>
            ...
            <div class="row align-items-stretch align-content-stretch g-0 topmargin">
                ...
                <div class="col-md-12 col-12 bg-white dark order-md-1">
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <button class="btn btn-blue-bordered btn-order bigger" data-type="social-media-marketing">Order Now</button>
                    </div>
                    <div class="feature-pc"></div>
                </div>
                            ...
                            <div class="card bg-white shadow-lg border-0">
                                <div class="card-body p-4">
                                    <div>
                                        ...
                                        <form class="row mb-0 form-services" id="form-enq" action="{{ route('postMeet') }}"
