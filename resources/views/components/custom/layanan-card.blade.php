...
<div class="col-lg-3 col-md-4 col-12 mb-5 pricing-table">
    <div class="card shadow h-100"
        ...
        <div class="d-flex flex-column justify-content-between h-100">
            ...
            <button class="btn w-100 text-white bg-color  btn-order rounded-3 p-3 fw-semibold text-uppercase ">Order Now</button>
        </div>
